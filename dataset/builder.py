...
from .triplet_dataset import MultiPoseDogDataset, ImagePairDataset
from .feature_dataset import FeatureDataset



def build_dataset(args, is_train, has_face=False):
    ...
    if args.data_set == 'CIFAR':
        ...
        dataset = ImagePairDataset(path, is_train, has_face, transform=transform)
        nb_classes = 1000
    ...
    elif args.data_set == 'feature':
        print("reading from datapath", args.data_path)
        if is_train:
            path = args.data_path + '/feature_train.txt'
        else:
            path = args.data_path + '/feature_test.txt'
